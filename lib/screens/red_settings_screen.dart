...
class RedSettingsScreen extends StatefulWidget {
  ...
  @override
  State<RedSettingsScreen> createState() => _RedSettingsScreenState();
}

class _RedSettingsScreenState extends State<RedSettingsScreen> {
  @override
